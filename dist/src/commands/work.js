import { SlashCommandBuilder, ActionRowBuilder, ButtonBuilder, ButtonStyle, EmbedBuilder, ThreadAutoArchiveDuration, MessageFlags, ChannelType } from 'discord.js';
...
export const work = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption(option => option.setName('branch')
    ...
    execute: async (interaction) => {
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields({ name: 'Branch', value: sanitizedBranch, inline: true }, { name: 'Path', value: worktreePath, inline: true }, { name: 'Created', value: new Date().toLocaleString(), inline: true })
                .setColor(0x2ecc71);
